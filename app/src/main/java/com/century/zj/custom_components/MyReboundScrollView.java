package com.century.zj.custom_components;
...
//      @param canvas
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int colorStart = getResources().getColor(R.color.white);//开始
        int color1 = Color.GRAY;
        int colorEnd = getResources().getColor(R.color.white);

        //LinearGradient线性渐变，这种设置的比较细腻，可设置多种颜色渐变
